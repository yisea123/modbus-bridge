...
int _bsp_pre_init(void)
{
    ...
    configure_uart_pins(1); // UART1_IDX
    configure_uart_pins(2); // UART2_IDX
    configure_uart_pins(3); // UART3_IDX
    configure_uart_pins(4); // UART4_IDX
#else
#error Default serial module is unsupported or undefined.
#endif
#endif
