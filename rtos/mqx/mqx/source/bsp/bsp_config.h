 ...
 */
    ...
    #define BSP_ALARM_FREQUENCY          (1000)	// Ticks per second (see init_bsp.c _time_set_ticks_per_sec())
#endif
...
*/
    ...
    #define BSP_ALARM_PERIOD             (1000)	// Tick period in microseconds (see init_bsp.c HWTIMER_SYS_SetPeriod())
#endif
