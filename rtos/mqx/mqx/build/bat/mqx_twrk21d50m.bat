...
copy "%ROOTDIR%\config\mcu\MK21DA5\mqx_sdk_config.h" "%OUTPUTDIR%\..\config\mqx_sdk_config.h" /Y
copy "%ROOTDIR%\config\board\twrk21d50m\user_config.h" "%OUTPUTDIR%\..\config\user_config.h" /Y
