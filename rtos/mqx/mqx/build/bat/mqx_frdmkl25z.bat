...
copy "%ROOTDIR%\config\mcu\MKL25Z4\mqx_sdk_config.h" "%OUTPUTDIR%\..\config\mqx_sdk_config.h" /Y
copy "%ROOTDIR%\config\board\frdmkl25z\user_config.h" "%OUTPUTDIR%\..\config\user_config.h" /Y
