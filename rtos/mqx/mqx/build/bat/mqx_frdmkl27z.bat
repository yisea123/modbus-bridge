...
copy "%ROOTDIR%\config\mcu\MKL27Z644\mqx_sdk_config.h" "%OUTPUTDIR%\..\config\mqx_sdk_config.h" /Y
copy "%ROOTDIR%\config\board\frdmkl27z\user_config.h" "%OUTPUTDIR%\..\config\user_config.h" /Y
