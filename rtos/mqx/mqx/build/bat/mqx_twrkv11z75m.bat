...
copy "%ROOTDIR%\config\mcu\MKV11Z7\mqx_sdk_config.h" "%OUTPUTDIR%\..\config\mqx_sdk_config.h" /Y
copy "%ROOTDIR%\config\board\twrkv11z75m\user_config.h" "%OUTPUTDIR%\..\config\user_config.h" /Y
