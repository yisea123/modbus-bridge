...
copy "%ROOTDIR%\config\mcu\MKW40Z4\mqx_sdk_config.h" "%OUTPUTDIR%\..\config\mqx_sdk_config.h" /Y
copy "%ROOTDIR%\config\board\usbkw40z_kw40z\user_config.h" "%OUTPUTDIR%\..\config\user_config.h" /Y
