...
copy "%ROOTDIR%\config\mcu\MKL43Z4\mqx_sdk_config.h" "%OUTPUTDIR%\..\config\mqx_sdk_config.h" /Y
copy "%ROOTDIR%\config\board\twrkl43z48m\user_config.h" "%OUTPUTDIR%\..\config\user_config.h" /Y
