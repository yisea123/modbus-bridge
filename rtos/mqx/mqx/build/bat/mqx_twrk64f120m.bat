...
copy "%ROOTDIR%\config\mcu\MK64F12\mqx_sdk_config.h" "%OUTPUTDIR%\..\config\mqx_sdk_config.h" /Y
copy "%ROOTDIR%\config\board\twrk64f120m\user_config.h" "%OUTPUTDIR%\..\config\user_config.h" /Y
