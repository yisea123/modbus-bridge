...
copy "%ROOTDIR%\config\mcu\MKV10Z7\mqx_sdk_config.h" "%OUTPUTDIR%\..\config\mqx_sdk_config.h" /Y
copy "%ROOTDIR%\config\board\frdmkv10z\user_config.h" "%OUTPUTDIR%\..\config\user_config.h" /Y
