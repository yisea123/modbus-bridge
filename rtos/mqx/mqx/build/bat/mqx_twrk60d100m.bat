...
copy "%ROOTDIR%\config\mcu\MK60D10\mqx_sdk_config.h" "%OUTPUTDIR%\..\config\mqx_sdk_config.h" /Y
copy "%ROOTDIR%\config\board\twrk60d100m\user_config.h" "%OUTPUTDIR%\..\config\user_config.h" /Y
