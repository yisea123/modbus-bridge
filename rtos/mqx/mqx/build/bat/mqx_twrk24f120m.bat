...
copy "%ROOTDIR%\config\mcu\MK24F25612\mqx_sdk_config.h" "%OUTPUTDIR%\..\config\mqx_sdk_config.h" /Y
copy "%ROOTDIR%\config\board\twrk24f120m\user_config.h" "%OUTPUTDIR%\..\config\user_config.h" /Y
