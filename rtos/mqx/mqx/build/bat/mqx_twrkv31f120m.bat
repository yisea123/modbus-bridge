...
copy "%ROOTDIR%\config\mcu\MKV31F51212\mqx_sdk_config.h" "%OUTPUTDIR%\..\config\mqx_sdk_config.h" /Y
copy "%ROOTDIR%\config\board\twrkv31f120m\user_config.h" "%OUTPUTDIR%\..\config\user_config.h" /Y
