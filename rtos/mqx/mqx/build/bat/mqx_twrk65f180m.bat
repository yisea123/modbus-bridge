...
copy "%ROOTDIR%\config\mcu\MK65F18\mqx_sdk_config.h" "%OUTPUTDIR%\..\config\mqx_sdk_config.h" /Y
copy "%ROOTDIR%\config\board\twrk65f180m\user_config.h" "%OUTPUTDIR%\..\config\user_config.h" /Y
